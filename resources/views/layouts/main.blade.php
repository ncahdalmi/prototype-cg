...
<body class="font-poppins bg-primary text-primary-white">
   ...
   <div class="z-50 fixed bg-secondary h-[50px] w-full md:hidden">
      <header class="flex items-center justify-between relative">
         ...
         <nav id="nav-menu"
            class="z-10 -translate-y-96 absolute py-2 px-2 bg-primary shadow-lg rounded-lg w-full top-full transition-all duration-300">
            <ul class="block">
               <li class="group">
