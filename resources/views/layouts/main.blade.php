    ...
    <div class="z-50 fixed bg-primary h-[50px] w-full">
      <header class="flex items-center justify-between relative">
        <div class="flex items-center px-4">
          ...
          <nav id="nav-menu" class="hidden absolute py-2 px-2 bg-primary shadow-lg rounded-lg max-w-[150px] w-full top-full">
            <ul class="block">
              <li class="group">
    ...
    <div class="z-30">
      <nav class="fixed bottom-0 inset-x-0 bg-primary h-[50px] flex justify-between">
        ...
        <a href="" class="ease-linear"><svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" 
          ...
          <a href=""><img src="{{ asset('img/user.jpg') }}" alt="" class="fill-purpink w-9 h-9 mt-2 mr-5 outline outline-purpink hover:fill-darkpink hover:-translate-y-2 hover:duration-700 rounded-full">></a>
      </nav>
    </div>
  </div>
  <script> 
