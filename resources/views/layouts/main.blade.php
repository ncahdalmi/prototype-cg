...
<body class="font-poppins bg-primary text-primary-white">
  <div class="hidden md:block">
      <header class="z-30 fixed top-0 inset-x-0 bg-primary h-[50px] flex justify-between">
        <a href="" class="mt-3 md:mr-[8rem] lg:mr-[23rem] xl:mr-[40rem] 2xl:mr-[50rem]">
        ...
        <a href="" class="bg-secondary-2 rounded-full my-2 hover:bg-primary-white group">
            <div class="px-3 mt-[5px]">
                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" 
                class="fill-purpink w-5 h-5 mb-1 inline">
                <path d="M22.3981 17.9001C22.0744 18.2139 21.9256 18.6676 21.9994 19.1126L23.1106 25.2626C23.2044 25.7839 22.9844 26.3114 22.5481 26.6126C22.1206 26.9251 21.5519 26.9626 21.0856 26.7126L15.5494 23.8251C15.3569 23.7226 15.1431 23.6676 14.9244 23.6614H14.5856C14.4681 23.6789 14.3531 23.7164 14.2481 23.7739L8.71061 26.6751C8.43686 26.8126 8.12686 26.8614 7.82311 26.8126C7.08311 26.6726 6.58936 25.9676 6.71061 25.2239L7.82311 19.0739C7.89686 18.6251 7.74811 18.1689 7.42436 17.8501L2.91061 13.4751C2.53311 13.1089 2.40186 12.5589 2.57436 12.0626C2.74186 11.5676 3.16936 11.2064 3.68561 11.1251L9.89811 10.2239C10.3706 10.1751 10.7856 9.88762 10.9981 9.46262L13.7356 3.85012C13.8006 3.72512 13.8844 3.61012 13.9856 3.51262L14.0981 3.42512C14.1569 3.36012 14.2244 3.30637 14.2994 3.26262L14.4356 3.21262L14.6481 3.12512H15.1744C15.6444 3.17387 16.0581 3.45512 16.2744 3.87512L19.0481 9.46262C19.2481 9.87137 19.6369 10.1551 20.0856 10.2239L26.2981 11.1251C26.8231 11.2001 27.2619 11.5626 27.4356 12.0626C27.5994 12.5639 27.4581 13.1139 27.0731 13.4751L22.3981 17.9001Z"/>
                </svg>
                <p class="inline text-[14px] text-primary-white font-semibold group-hover:text-primary">Menfess</p>
            </div>  
        </a>
        <a href="" class="z-50"><x:feather-log-out class="text-primary-white w-6 h-6 mt-3" /></a>
        <div class="px-2 mr-5 pt-1 bg-secondary-2 rounded-full my-2 hover:bg-primary-white group">
            <a href=""><img src="{{ asset('img/user.jpg') }}" alt="" class="inline fill-purpink w-7 h-7 mr-2 rounded-full"></a>
            <p class="inline text-[14px] text-primary-white font-semibold group-hover:text-primary">{{ auth()->user()->username }}</p>
        </div> 
      </header>
  </div>
  <div class="z-50 fixed bg-primary h-[50px] w-full md:hidden">
    <header class="flex items-center justify-between relative">
      ...
      <nav id="nav-menu" class="z-10 -translate-y-96 absolute py-2 px-2 bg-primary shadow-lg rounded-lg w-full top-full transition-all duration-300">
        <ul class="block">
          <li class="group">
      ...
      <a href=""><x:feather-search class="w-9 mt-2 text-purpink mr-4" /></a>
    </header>
  </div>
  <div class="grid">
    <div>
